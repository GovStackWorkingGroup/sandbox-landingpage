...
.demo-image {
  width: 592px;
  height: 290px;
  background: url('@/assets/images/high-school-demo-image.png') left center no-repeat;
}
...
.featured-building-blocks {
  height: 126px;
  background: url('@/assets/images/high-school-building-blocks.png') left center no-repeat;
}
